...
import { yueJadiBot } from './plugins/Socket•socket.js';
...
printQRInTerminal: opcion == '1' ? true : methodCodeQR ? true : false,
mobile: MethodMobile, 
browser: opcion == '1' ? ['Yue-Bot', 'Edge', '20.0.04'] : methodCodeQR ? ['Yue-Bot', 'Edge', '20.0.04'] : ["Ubuntu", "Chrome", "20.0.04"],
auth: {
creds: state.creds,
keys: makeCacheableSignalKeyStore(state.keys, pino({ level: "fatal" }).child({ level: "fatal" })),
},
 ...
 */
global.rutaJadiBot = join(__dirname, '../YueJadiBot')

if (global.yueJadibts) {
...
yueJadiBot({pathYueJadiBot: botPath, m: null, conn, args: '', usedPrefix: '/', command: 'serbot'})
}
}
}
}
